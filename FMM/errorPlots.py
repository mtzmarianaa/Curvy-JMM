...
x_FMM = np.fromfile('Outputs/from_FMM_h001k8_bTree.bin')
...
x_exact = np.fromfile('Outputs/exact_h001k8.bin')
...
# x_FMM_n = np.fromfile('Outputs/from_FMM_h001k1.bin')
# x_exact_n = np.fromfile('Outputs/exact_h001k1.bin')
# rel_err_n = [norm(x_FMM_n -x_exact_n, 2 )/norm(x_exact_n, 2)]
# x_FMM_n = np.fromfile('Outputs/from_FMM_h001k2.bin')
# x_exact_n = np.fromfile('Outputs/exact_h001k2.bin')
# rel_err_n.append(norm(x_FMM_n -x_exact_n, 2 )/norm(x_exact_n, 2))
# x_FMM_n = np.fromfile('Outputs/from_FMM_h001k3.bin')
# x_exact_n = np.fromfile('Outputs/exact_h001k3.bin')
# rel_err_n.append(norm(x_FMM_n -x_exact_n, 2 )/norm(x_exact_n, 2))
# x_FMM_n = np.fromfile('Outputs/from_FMM_h001k4.bin')
# x_exact_n = np.fromfile('Outputs/exact_h001k4.bin')
# rel_err_n.append(norm(x_FMM_n -x_exact_n, 2 )/norm(x_exact_n, 2))
# x_FMM_n = np.fromfile('Outputs/from_FMM_h001k5.bin')
# x_exact_n = np.fromfile('Outputs/exact_h001k5.bin')
# rel_err_n.append(norm(x_FMM_n -x_exact_n, 2 )/norm(x_exact_n, 2))
# x_FMM_n = np.fromfile('Outputs/from_FMM_h001k6.bin')
# x_exact_n = np.fromfile('Outputs/exact_h001k6.bin')
# rel_err_n.append(norm(x_FMM_n -x_exact_n, 2 )/norm(x_exact_n, 2))
# x_FMM_n = np.fromfile('Outputs/from_FMM_h001k7.bin')
# x_exact_n = np.fromfile('Outputs/exact_h001k7.bin')
# rel_err_n.append(norm(x_FMM_n -x_exact_n, 2 )/norm(x_exact_n, 2))
# x_FMM_n = np.fromfile('Outputs/from_FMM_h001k8_bTree.bin')
# x_exact_n = np.fromfile('Outputs/exact_h001k8_bTree.bin')
# rel_err_n.append(norm(x_FMM_n -x_exact_n, 2 )/norm(x_exact_n, 2))
