...
def generatePlotsOnGeometry(H, eik_coords = 0, eik_vals = 0, eik_grads = 0,
                            eta1 = eta1, eta2 = eta2, x0 = x0, center = center, R = R,
                            spacingGrid = spacingGrid, errorsOnGeometry = True,
                            saveFigures = saveFigures,
                            true_solGrid = 0, type_solution = 0, ):
    '''
    ...
    :param ndarray eik_coords: coordinates for the points in the mesh
    :param ndarray eik_vals: eikonal values for the points in the mesh (with solver)
    :param ndarray eik_grads: gradient of the eikonal in the mesh from the solver
