...
# eik_vals_H2 = np.fromfile("/Users/marianamartinez/Documents/NYU-Courant/FMM-Project/FMM/TestBaseSnow/H6/H6_ComputedValues.bin")
# eik_coords_H2 = np.genfromtxt("/Users/marianamartinez/Documents/NYU-Courant/FMM-Project/FMM/TestBaseSnow/H6/H6_MeshPoints.txt", delimiter=",")
# triangles_H2 = np.genfromtxt("/Users/marianamartinez/Documents/NYU-Courant/FMM-Project/FMM/TestBaseSnow/H6/H6_Faces.txt", delimiter=",")
# eik_grads_H2 = np.fromfile("/Users/marianamartinez/Documents/NYU-Courant/FMM-Project/FMM/TestBaseSnow/H6/H6_ComputedGradients.bin");
# eik_grads_H2 = eik_grads_H2.reshape(len(eik_coords_H2), 2)
# eik_parents_H2 = np.fromfile("/Users/marianamartinez/Documents/NYU-Courant/FMM-Project/FMM/TestBaseSnow/H6/H6_Parents.bin", dtype=np.int32)
# eik_parents_H2 = eik_parents_H2.reshape(len(eik_coords_H2), 2)
# eik_lambdas_H2 = np.fromfile("/Users/marianamartinez/Documents/NYU-Courant/FMM-Project/FMM/TestBaseSnow/H6/H6_LambdasOpt.bin")
...
# path1_H2 = getPathFromIndex(eik_coords_H2, 100, eik_parents_H2, eik_lambdas_H2)
# # print("Second trial node")
# # path2_H2 = getPathFromIndex(eik_coords_H2, 203, eik_parents_H2, eik_lambdas_H2)
# # print("Third trial node")
# # path3_H2 = getPathFromIndex(eik_coords_H2, 75, eik_parents_H2, eik_lambdas_H2)
# # fig = plt.figure(figsize=(800/my_dpi, 800/my_dpi), dpi=my_dpi)
# plt.axis('equal')
# ax = plt.gca( )
# im29 = plt.imshow( zi_lin, cmap = colormap2, extent=[-18,18,-18,24]  )
# plt.triplot(eik_coords_H2[:, 0], eik_coords_H2[:, 1], triangles_H2, '-.', lw=0.5, c='#6800ff')
# plt.plot( [p[0] for p in path1_H2], [p[1] for p in path1_H2], marker = ".", c = "#ffffff", linewidth=2 )
# # plt.plot( [p[0] for p in path2_H2], [p[1] for p in path2_H2], marker = ".", c = "#dbdbdb", linewidth=2 )
# # plt.plot( [p[0] for p in path3_H2], [p[1] for p in path3_H2], marker = ".", c = "#b0b0b0", linewidth=2 )
# circle_b = plt.Circle((0, 0), 10, color="#000536",fill=False)
# ax.add_patch(circle_b)
# plt.scatter( eik_coords_H2[[100], 0], eik_coords_H2[[100], 1], marker='o', c = "#c100ff" )
# plt.title("Linear interpolation with some paths, test geometry just base H6")
# plt.show(block = False)
# plt.colorbar(im29)
# plt.savefig('/Users/marianamartinez/Documents/NYU-Courant/FMM-bib/Figures/TestBaseSnow/H6/H6_LinearInt_Paths.png', dpi=my_dpi * 10)
