...
eik_vals = np.fromfile("/Users/marianamartinez/Documents/NYU-Courant/FMM-Project/FMM/TestArch/ComputedValues.bin")
eik_coords = np.genfromtxt("/Users/marianamartinez/Documents/NYU-Courant/FMM-Project/FMM/TestArch/MeshPoints.txt", delimiter=",")
triangles = np.genfromtxt("/Users/marianamartinez/Documents/NYU-Courant/FMM-Project/FMM/TestArch/Faces.txt", delimiter=",")
...
plt.title("Computed eikonal values, square with arch")
plt.show(block = False)
...
eik_vals2 = np.fromfile("/Users/marianamartinez/Documents/NYU-Courant/FMM-Project/FMM/TestArch/ComputedValues2.bin")
