...
gcc $CFLAGS -c memCache.c -o memCache.o
gcc $CFLAGS -c eik_grid.c -o eik_grid.o
gcc $CFLAGS -o test_eik_gridEasy test_eik_gridEasy.o mesh2D.o eik_grid.o marcher_T2.o  files_methods.o neighbors.o linAlg.o priority_queue.o opti_method.o memCache.o -ljson-c -lm
