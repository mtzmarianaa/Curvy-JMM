...
#           return params_test_proj[0], params_test_proj[1], params_test_proj[2]
...
#           i += 1
#      if( f_before <= f_test and f_before <= f_test_proj ):
#           return params[2*nRegions - 3], params[2*nRegions - 2], params[2*nRegions - 1]
#      elif( f_test < f_test_proj):
#           return params_test[2*nRegions - 3], params_test[2*nRegions - 2], params_test[2*nRegions - 1]
#      else:
#           return params_test_proj[2*nRegions - 3], params_test_proj[2*nRegions - 2], params_test_proj[2*nRegions - 1]
