...
int main(){
  ...
  printf("\n\n\n\n\n\n\n\n\n\n Project back different types of curvy triangle - for figures\n");
  double lambdak1, yk1[2], ykPrime[2], x0[2], B0_k1[2], Bk_mu[2], Bk_mu_perp[2], x_k[2], x_k1[2], B_k1[2];
  double B0_k[2], Bk[2];
  ...
  /* yk1[0] = 0; */
  /* yk1[1] = 0; */
  /* ykPrime[0] = 1.71137263; */
  /* ykPrime[1] = -0.10010285; */
  /* x0[0] = 0; */
  /* x0[1] = 0; */
  /* B0_k1[0] = 0.5547002; */
  /* B0_k1[1] = 0.83205029; */
  ...
  /* x_k1[0] = 1.5; */
  /* x_k1[1] = 0.8; */
  /* grad_hermite_interpolationSpatial(0.8, x0, x_k, B0_k, Bk, Bk_mu); */
  /* Bk_mu_perp[0] = - Bk_mu[1]; */
  /* Bk_mu_perp[1] = Bk_mu[0]; */
  
  /* projectBack_type1(&lambdak1, yk1, ykPrime, x0, B0_k1, Bk_mu, Bk_mu_perp, x_k, x_k1, B_k1, 0.000001, 50); */
  /* printf("Projected lambda: %lf:\n", lambdak1); */


  // TYPE 2

  /* double Bk1_lam[2], Bk1_lam_perp[2]; */

  /* lambdak1 = 1; */
  /* yk1[0] = 1.5; */
  /* yk1[1] = 0.8; */
  /* ykPrime[0] = 0.04963604; */
  /* ykPrime[1] = -0.09296396; */
  /* x0[0] = 0; */
  /* x0[1] = 0; */
  /* B0_k1[0] = 0.9701425; */
  /* B0_k1[1] = 0.24253563; */
  ...
  /* x_k1[0] = 1.5; */
  /* x_k1[1] = 0.8; */
  /* grad_hermite_interpolationSpatial(0.1, x0, x_k1, B0_k1, B_k1, Bk1_lam); */
  /* Bk1_lam_perp[0] = - Bk1_lam[1]; */
  /* Bk1_lam_perp[1] = Bk1_lam[0]; */
  
  /* projectBack_type2(&lambdak1, yk1, ykPrime, x0, B0_k1, Bk_mu, Bk_mu_perp, x_k, x_k1, B_k1, 0.000001, 50); */
  /* printf("Projected lambda: %lf:\n", lambdak1); */
  ...
  yk1[0] = 0;
  yk1[1] = 0;
  ykPrime[0] = 0.77581827;
  ykPrime[1] = 0.03240738;
  x0[0] = 0;
  x0[1] = 0;
  B0_k1[0] = 0.9701425;
  B0_k1[1] = 0.24253563;
  ...
  x_k1[0] = 1.5;
  x_k1[1] = 0.8;
  grad_hermite_interpolationSpatial(0, x0, x_k1, B0_k1, B_k1, Bk1_lam);
  Bk1_lam_perp[0] = - Bk1_lam[1];
  Bk1_lam_perp[1] = Bk1_lam[0];
  grad_hermite_interpolationSpatial(0.4, x0, x_k, B0_k, Bk, Bk_mu);
  Bk_mu_perp[0] = - Bk_mu[1];
  Bk_mu_perp[1] = Bk_mu[0];
  
  projectBack_type4(&lambdak1, yk1, ykPrime, x0, B0_k1, Bk_mu, Bk_mu_perp, Bk1_lam_perp, x_k, x_k1, B_k1, 0.000001, 50);
  printf("Projected lambda: %lf:\n", lambdak1);
