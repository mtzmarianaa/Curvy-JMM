...
int main(){
    ...
    pathSaveEiks = "./H7/H7_ComputedValuesFast.bin";
    pathSaveGrads = "./H7/H7_ComputedGradientsFast.bin";
    ...
    pathSaveEiks = "./H8/H8_ComputedValuesFast.bin";
    pathSaveGrads = "./H8/H8_ComputedGradientsFast.bin";
    ...
    pathPoints = "./H9/H9_MeshPoints.txt";
    pathFaces = "./H9/H9_Faces.txt";
    pathEdges = "./H9/H9_Edges.txt";
    pathEdgesInFace = "./H9/H9_EdgesInFace.txt";
    pathNeighbors = "./H9/H9_Neigh.txt";
    pathIncidentFaces = "./H9/H9_IncidentFaces.txt";
    pathIndices = "./H9/H9_Indices.txt";
    pathIndices = "./H9/H9_Indices.txt";
    pathBoundary = "./H9/H9_BoundaryCurve.txt";

    pathSaveEiks = "./H9/H9_ComputedValuesFast.bin";
    pathSaveGrads = "./H9/H9_ComputedGradientsFast.bin";
    pathTimes = "./H9/H9_Times.bin";
